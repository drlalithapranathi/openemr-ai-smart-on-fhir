...
### Arthritis
ref_arthritis = """Doctor: Good morning, Mr. Taylor. Come in and have a seat. How are you doing today?
...
hypotheses_files = ["gallstones1.txt","gerd1.txt","arthritis1.txt","dka1.txt", "copd1.txt", "anemia1.txt"]
hypotheses = []
...
for filename in hypotheses_files:
    with open(data_dir / filename, 'r', encoding='utf-8') as f:
        text = f.read()
        hypotheses.append(text)  # keep as-is
